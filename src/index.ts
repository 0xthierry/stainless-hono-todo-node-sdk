...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['TODO_HONO_SDK_BASE_URL'].
   */
...
/**
 * API Client for interfacing with the Todo Hono SDK API.
 */
export class TodoHonoSDK extends Core.APIClient {
  private _options: ClientOptions;

  /**
   * API Client for interfacing with the Todo Hono SDK API.
   *
   * @param {string} [opts.baseURL=process.env['TODO_HONO_SDK_BASE_URL'] ?? https://localhost:8080/test-api] - Override the default base URL for the API.
   ...
   */
  constructor({ baseURL = Core.readEnv('TODO_HONO_SDK_BASE_URL'), ...opts }: ClientOptions = {}) {
  ...
  static TodoHonoSDK = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static TodoHonoSDKError = Errors.TodoHonoSDKError;
